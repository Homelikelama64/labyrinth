kill @e[tag=Terrain]
execute align xyz run summon armor_stand ~5 ~2 ~5 {Tags:[Terrain],NoAI:1,NoGravity:1,Invulnerable:1}
...
scoreboard players operation terrainsizex LABYRINTH = MAPSCALE LABYRINTH
scoreboard players set #5 LABYRINTH 5
scoreboard players operation terrainsizex LABYRINTH /= #5 LABYRINTH

scoreboard players operation terrainsizey LABYRINTH = MAPSCALEY LABYRINTH
scoreboard players set #5 LABYRINTH 5
scoreboard players operation terrainsizey LABYRINTH /= #5 LABYRINTH
